...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/world2data-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15406&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/world2data-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `world2data` can be installed with:

```
conda install world2data
```

It is possible to list all of the versions of `world2data` available on your platform with:
